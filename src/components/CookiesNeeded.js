...
class CookiesNeeded extends React.Component {
  ...
  render() {
    return (
        ...
        <p style={{width: "90%",margin: "auto", textAlign: "justify"}}>En poursuivant votre navigation, vous acceptez l’utilisation de cookies pour améliorer votre expérience sur notre site et/ou la fourniture des services proposés par Online Survey.
         Ces types de cookies ne sont déposés sur vos terminaux qu’à condition que vous y consentiez, sur le site Internet ou l’application mobile de Online Survey. 
          Consultez les <a onClick={this.DisplayLegal} href="#legal">Mentions Légales relatives à la RGPD</a> pour en savoir plus.</p>
