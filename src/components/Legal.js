  ...
  render() {
    ...
    return (
      <div style={{ margin: "10%" }}>
        ...
        utilisateurs du site internet <b>Online Survey</b> l'identité des
        différents intervenants dans le cadre de sa réalisation et de son suivi
        : <br />
        <strong>Propriétaire :</strong> SAS BigBrother – 6, rue eugénie Brazier
        67400 Illkirch-Graffenstaden
        <br />
        <strong>Responsable publication :</strong> Aurélie DUPREZ –
        280120@supinfo.com
        <br />
        Le responsable publication est une personne physique.
        <br />
        <strong>Webmasters :</strong> Quentin GRUBER – 280120@supinfo.com et
        Maxime BIER – 280120@supinfo.com
        <br />
        <strong>Hébergeur :</strong> Amazon Web Services – 67 Boulevard du
        Général Leclerc 92110 Clichy 01 74 18 10 38
        <br />
        <strong>Délégué à la protection des données :</strong> DUPREZ Aurélie –
        280120@supinfo.com
        <br />
        <br />
        <div id="cgu">
        ...
        <br />
        L’utilisation du site Online Survey implique l’acceptation pleine et
        ...
        complétées à tout moment, les utilisateurs du site sont donc invités à
        ...
        être toutefois décidée par Online Survey, qui s’efforcera alors de
        ...
        est mis à jour régulièrement par Big Brother. De la même façon, les
        ...
        activités de la société. Online Survey s’efforce de fournir sur le site{" "}
        <a href="https://www.online-survey.app">
          https://www.online-survey.app
        </a>{" "}
        ...
        écrite préalable du Responsable de Publication et/ou du Webmaster. Toute
        ...
        marché ou perte d’une chance) consécutifs à l’utilisation du site. Des
        espaces interactifs (possibilité de poser des questions dans l’espace
        contact) sont à la disposition des utilisateurs. Online Survey se
        ...
        protection des données. Le cas échéant, Online Survey se réserve
        ...
        Online Survey est représenté par Laurent CUSIMANO, son représentant
        légal. En tant que responsable du traitement des données qu’il collecte,
        Online Survey s’engage à respecter le cadre des dispositions légales en
        vigueur. Il lui appartient notamment au Client d’établir les finalités
        ...
        registre des traitements conforme à la réalité. Chaque fois que Online
        Survey traite des Données Personnelles, BigBrother prend toutes les
        mesures raisonnables pour s’assurer de l’exactitude et de la pertinence
        des Données Personnelles au regard des finalités pour lesquelles Online
        Survey les traite.
        <br />
        <br />
        <div id="data_use">
        ...
        commandes, etc, • Pour prévenir et lutter contre la fraude informatique
        (spamming, hacking…) : matériel informatique utilisé pour la navigation,
        l’adresse IP, le mot de passe (hashé), • Pour améliorer la navigation
        sur le Site : données de connexion et d’utilisation, • Pour mener des
        enquêtes de satisfaction facultatives, • Pour mener des campagnes de
        communication (sms, mail) : numéro de téléphone, adresse email.
        <a href="https://www.online-survey.app">
          https://www.online-survey.app
        </a>{" "}
        ...
        la communication ou la conservation est interdite <br />• Droit de
        retirer à tout moment un consentement <i>(article 13-2c RGPD)</i>,{" "}
        <br />• Droit à la limitation du traitement des données des Utilisateurs{" "}
        <i>(article 18 RGPD)</i>,<br />• Droit d’opposition au traitement des
        données des Utilisateurs <i>(article 21 RGPD)</i>,<br />• Droit à la
        portabilité des données que les Utilisateurs auront fournies, lorsque
        ces données font l’objet de traitements automatisés fondés sur leur
        consentement ou sur un contrat (<i>article 20 RGPD</i>),
        <br />
        • Droit de définir le sort des données des Utilisateurs après leur mort
        et de choisir à qui Online Survey devra communiquer (ou non) ses données
        à un tiers qu’ils aura préalablement désigné.
        <br />
        Dès que Online Survey a connaissance du décès d’un Utilisateur et à
        défaut d’instructions de sa part, le responsable de la Base de Données
        ...
        légale. Si l’Utilisateur souhaite savoir comment Online Survey utilise
        ses Données Personnelles, demander à les rectifier ou s’oppose à leur
        traitement, l’Utilisateur peut contacter le support par écrit à
        l’adresse suivante :
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BigBrother – DPO, DBA DUPREZ Aurélie
        <br />
        6, rue Eugénie Brazier 67400 Illkirch-Graffenstaden. Dans ce cas,
        l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait
        corriger, mettre à jour ou supprimer, en s’identifiant précisément avec
        une copie d’une pièce d’identité (carte d’identité ou passeport). Les
        demandes de suppression de Données Personnelles seront soumises aux
        obligations qui sont imposées à Online Survey par la loi, notamment en
        matière de conservation ou d’archivage des documents. Enfin, les
        Utilisateurs de Online Survey peuvent déposer une réclamation auprès des
        ...
        européenne sans en informer préalablement le client. Pour autant, Online
        Survey reste libre du choix de ses sous-traitants techniques et
        commerciaux à la condition qu’il présente les garanties suffisantes au
        regard des exigences du Règlement Général sur la Protection des Données
        (RGPD : n° 2016-679). Online Survey s’engage à prendre toutes les
        ...
        confidentialité des Informations du Client est portée à la connaissance
        de BigBrother, celle-ci devra dans les meilleurs délais informer le
        Client et lui communiquer les mesures de corrections prises. Par
        ailleurs Online Survey ne collecte aucune « données sensibles ».
        <br />
        ...
        fin de la relation contractuelle : adresse mail, nom et prénom
        (optionnel), nom d'utilisateur Online Survey l’expérience utilisateur et
        de proposer des conseils contextualisés : cookies relatifs à la session
        ...
        reporting. Aucune information personnelle de l'utilisateur du site
        Online Survey n'est publiée à l'insu de l'utilisateur, échangée,
        transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
        l'hypothèse du rachat de Online Survey et de ses droits permettrait la
        ...
        Personnelles et des Données Personnelles de Santé, Online Survey utilise
        des réseaux protégés par des dispositifs standards tels que par
        pare-feu, la pseudonymisation, l’encryption et mot de passe. Lors du
        traitement des Données Personnelles, Online Survey prend toutes les
        ...
        en place avec l’autorisation de BigBrother. Cependant, Online Survey n’a
        pas la possibilité de vérifier le contenu des sites ainsi visités, et
        n’assumera en conséquence aucune responsabilité de ce fait. Sauf si vous
        décidez de désactiver les cookies, vous acceptez que le site puisse les
        utiliser. Vous pouvez à tout moment désactiver ces cookies et ce
        gratuitement à partir des possibilités de désactivation qui vous sont
        offertes et rappelées ci-après, sachant que cela peut réduire ou
        ...
        de l’Utilisateur. Online Survey est susceptible de traiter les
        informations de l’Utilisateur concernant sa visite du Site, telles que
        les pages consultées, les recherches effectuées. Ces informations
        permettent à BigBrother d’améliorer le contenu du Site, de la navigation
        ...
        souhaite ou non les accepter de manière que des Cookies soient
        ...
        dans son terminal. Online Survey informe l’Utilisateur que, dans ce cas,
        il se peut que les fonctionnalités de son logiciel de navigation ne
        soient pas toutes disponibles. Si l’Utilisateur refuse l’enregistrement
        de Cookies dans son terminal ou son navigateur, ou si l’Utilisateur
        supprime ceux qui y sont enregistrés, l’Utilisateur est informé que sa
        navigation et son expérience sur le Site peuvent être limitées. Cela
        pourrait également être le cas lorsque Online Survey ou l’un de ses
        ...
        connecté à Internet. Le cas échéant, Online Survey décline toute
        responsabilité pour les conséquences liées au fonctionnement dégradé du
        Site et des services éventuellement proposés par BigBrother, résultant
        ...
        en matière de Cookies. Online Survey pourra en outre faire appel aux
        services de prestataires externes pour l’aider à recueillir et traiter
        les informations décrites dans cette section. Enfin, en cliquant sur les
        icônes dédiées aux réseaux sociaux Twitter, Facebook, Linkedin et Google
        Plus figurant sur le Site de{" "}
        <a href="https://www.online-survey.app">
          https://www.online-survey.app
        </a>{" "}
        ...
        portable). Ces types de cookies ne sont déposés sur vos terminaux qu’à
        condition que vous y consentiez, en continuant votre navigation sur le
        ...
        compris l’adresse IP de l’Utilisateur) dans un pays étranger. Ces
        balises sont placées à la fois dans les publicités en ligne permettant
        aux internautes d’accéder au Site, et sur les différentes pages de
        celui-ci. Cette technologie permet à Online Survey d’évaluer les
        ...
        consultées), ainsi que l’utilisation de ce Site par l’Utilisateur. Le
        prestataire externe pourra éventuellement recueillir des informations
        ...
        compétents de Strasbourg Définitions des personnes morales et physiques
        mentionnées ci-dessus : Client : tout professionnel ou personne physique
        ...
        le Site, notamment textes – images – vidéos. Informations clients :
        Ci-après dénommé « Information (s) » qui correspondent à l’ensemble des
        données personnelles susceptibles d’être détenues par Online Survey pour
        la gestion de votre compte, de la gestion de la relation client et à des
        fins d’analyses et de statistiques. Utilisateur : Internaute se
        connectant, utilisant le site susnommé. Informations personnelles : «
        ...
        elles s'appliquent » (
        <i>article 4 de la loi n° 78-17 du 6 janvier 1978</i>article 4 de la loi
